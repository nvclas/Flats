...
import de.nvclas.flats.core.commands.MainSubCommand;
...
public class ShowSubCommand implements SubCommand {
    ...
    public ShowSubCommand(BaseFlats plugin) {
        this.plugin = plugin;
    ...
    public void execute(@NotNull Player player, @NotNull String @NotNull [] args) {
        ...
        if (flatsAmount == 1) {
            player.sendMessage(plugin.getPrefix() + I18n.translate("show.success.singular", DEFAULT_SHOW_TIME));
        } else {
            player.sendMessage(
