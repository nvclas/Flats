...
import de.nvclas.flats.core.util.LocationConverter;
...
public class Area {
    ...
    public static Area fromRawData(@NotNull String worldName, @NotNull Bounds bounds, @NotNull String flatName) {
        ...
        return new Area(pos1, pos2, worldName, flatName, bounds.toLocationString(worldName), bounds);
    }
    ...
    private @NotNull Location[] getCorners(World world) {
        ...
        return new Location[]{new Location(world, x1, y1, z1), new Location(world, x2, y1, z1),
                new Location(world, x1, y2, z1), new Location(world, x1, y1, z2), new Location(world, x2, y2, z1),
                new Location(world, x2, y1, z2), new Location(world, x1, y2, z2), new Location(world, x2, y2, z2)};
    }
    ...
    public record Bounds(int minX, int maxX, int minY, int maxY, int minZ, int maxZ) {
        ...
        public static Bounds fromLocations(@NotNull Location pos1, @NotNull Location pos2) {
            return new Bounds(Math.min(pos1.getBlockX(), pos2.getBlockX()),
                    Math.max(pos1.getBlockX(), pos2.getBlockX()), Math.min(pos1.getBlockY(), pos2.getBlockY()),
                    Math.max(pos1.getBlockY(), pos2.getBlockY()), Math.min(pos1.getBlockZ(), pos2.getBlockZ()),
